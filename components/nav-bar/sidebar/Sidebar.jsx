...
const Sidebar = () => {
  ...
  return (
    <>
      {isVisible && (
        <div
          className={`absolute inset-0 bg-black/60 w-screen h-screen z-40 sm:hidden transition-opacity duration-300 ease-in-out ${
            isVisible
      ...
      <nav
        className={`bg-sidebar absolute h-screen w-72 p-6 z-50 transition-transform duration-300 ease-in-out transform sm:hidden ${
